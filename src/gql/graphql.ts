...
export type UserFrangmentFragment = {
  __typename?: "User";
  _id: string;
  email: string;
  username: string;
...
export const UserFrangmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "userFrangment" },
      typeCondition: {
        kind: "NamedType",
...
} as unknown as DocumentNode<UserFrangmentFragment, unknown>;
